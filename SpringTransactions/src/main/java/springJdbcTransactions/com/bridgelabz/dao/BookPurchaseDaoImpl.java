package springJdbcTransactions.com.bridgelabz.dao;
...
@Repository
public class BookPurchaseDaoImpl extends NamedParameterJdbcDaoSupport implements BookPurchaseDao {
	...
	public int getBookPrice(int bookId) {
		...
		int bookPrice = getNamedParameterJdbcTemplate().queryForObject(sql, paramMap, Integer.class);
		return bookPrice;
	}
	...
	public int getUserAccountBalance(int userId) {
		...
		int balance = getNamedParameterJdbcTemplate().queryForObject(sql, paramMap, Integer.class);
		return balance;
	}
	...
	public int getBookStock(int bookId) {
		...
		int bookStock = getNamedParameterJdbcTemplate().queryForObject(sql, paramMap, Integer.class);
		return bookStock;
	}
	...
	private boolean authenticate(int userId, String userPass) {
		...
		Map<String, Integer> paramMap = new HashMap<String, Integer>();
		paramMap.put("userId", userId);
		String storedPassword = getNamedParameterJdbcTemplate().queryForObject(sql, paramMap, String.class);
